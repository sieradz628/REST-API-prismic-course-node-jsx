...
import DisplayCategory from './Components/common/DisplayCategory';
    ...
    <>
      ...
      <ul>
        {data.map((el, index) => { // use the map () function to display our articles
          return <li key={index}><a href={`/blog/article/${el.uid}`}>{el.data.title[0].text}</a> category: <DisplayCategory category={el.data.categories}/></li> })
        }
